...
public class TestWorld implements Screen {
	...
	public void show() {
		...
		LightFactory.createCyclePoint(world, AnimusWorld.rayHandler,  AnimusWorld.numRays, new Color(1.0f, 1.0f, 0.9f, 1.0f), AnimusWorld.lightDistance*2, 35f, 11f, 6.0f, 3.2f).addToWorld();
