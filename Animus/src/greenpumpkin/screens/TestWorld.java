...
public class TestWorld implements Screen {
	...
	public void show() {
		...
		LightFactory.createCyclePoint(world, AnimusWorld.rayHandler,  AnimusWorld.numRays, new Color(0.0f, 0.1f, 0.8f, 1.0f), AnimusWorld.lightDistance*1.5f, 6f, 1.0f,100f, 30f/64f).addToWorld();
		LightFactory.createCyclePoint(world, AnimusWorld.rayHandler,  AnimusWorld.numRays, new Color(1.0f, 1.0f, 0.9f, 1.0f), AnimusWorld.lightDistance, 35f, 11f, 100f, 1.875f*4f).addToWorld();
